...
public class pythonLexer extends Lexer {
	...
	public static final int
		...
		DEF=43, STRING=44, FROM=45, IMPORT=46, NAME=47, NL=48, WS=49;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"COMMENT", "NUM", "DOUBLE", "POW", "STAR", "DIV", "PLUS", "SUB", "EQ", 
			"NEQ", "LT", "GT", "LTE", "GTE", "AND", "OR", "NOT", "IF", "ELIF", "ELSE", 
			"PRINT", "RETURN", "TRUE", "FALSE", "FOR", "IN", "WHILE", "BREAK", "CONTINUE", 
			"NONE", "ASSIGN", "COLON", "LPAREN", "RPAREN", "COMMA", "LBRACK", "RBRACK", 
			"LBRACE", "RBRACE", "DOT", "AT", "CLASS", "DEF", "STRING", "FROM", "IMPORT", 
			"NAME", "NL", "WS"
		};
	}
